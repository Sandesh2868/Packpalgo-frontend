...
const Button = ({ children, onClick, className = "", style = {} }) => (
  <button
    onClick={onClick}
    className={`px-4 py-2 rounded-lg transition min-w-32 max-w-[160px] mx-auto w-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 ${className}`}
    style={{
    ...
    <main className="relative min-h-screen overflow-x-hidden" style={{ color: "var(--text)" }}>
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center w-full">
          <HeroBackground />
          <h1
            className="text-5xl md:text-7xl font-extrabold mb-4 tracking-tight font-sans"
          ...
          <div className="flex justify-center mt-10">
            <span className="animate-bounce-slow text-2xl select-none" style={{ color: "var(--text)" }}>
